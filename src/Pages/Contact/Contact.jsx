...
const Contact = () => {
  ...
  return (
    <div className="relative ">
      <div className="flex flex-col lg:items-center lg:flex-row pt-16 px-10 pb-16 mb-10 w-full bg-black ">
        <div>
          <div className=" text-center lg:text-left mb-6 md:md-0">
        ...
        <div className="lg:w-3/5 md:w-3/4 px-8 md:px-6 py-8 border border-gray-200 mx-auto rounded-lg shadow-md  bg-white ">
          ...
          <form onSubmit={handleSubmit} className="w-full ">
            ...
            <div className="flex items-center justify-center">
              ...
              >
                <div className=""></div>
                <span className="relative text-black group-hover:text-white transition duration-300">
                  Send Message
                </span>
              </button>
            </div>
      ...
      {/* Address part */}
      <div className="md:w-[90%] md:gap-x-3 lg:gap-0 flex flex-col justify-between md:flex-row my-16 items-center mx-auto ">
        ...
        <div className="flex-1 lg:mx-24 mt-10 ">
          ...
          <div className="p-4 flex items-center gap-x-3 ">
            <FaLocationDot className="lg:text-5xl text-4xl text-black  border rounded-full p-2 " />
            <p className="lg:text-xl ">
              Asian Properties Road, House-2,
          ...
          <div className="p-4 flex items-center gap-x-3">
            <BiSolidPhoneCall className="lg:text-5xl text-4xl text-black  border rounded-full p-2 " />
            <p className="lg:text-xl ">
              +123 0012 47854 <br /> +89 0125 123645
            </p>
          </div>
        </div>
      </div>
