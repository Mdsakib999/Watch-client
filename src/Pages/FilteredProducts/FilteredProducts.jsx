      ...
      <div className="mt-4 md:mt-0 mx-auto flex flex-col items-center justify-center">
        ...
        {filteredProducts.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center h-[50vh]">
            <p className="text-lg text-gray-400 flex items-center gap-x-2 mb-20">
              <TbShoppingBagX size={34} /> Currently no products available.
            </p>
            <Link
              to="/allProducts"
              className="px-6 py-3 uppercase mb-4 rounded-lg font-semibold text-white  transition-all duration-500 bg-gradient-to-r from-[#03b8e1] via-[#112949] to-[#00c4f5] bg-[length:200%_auto] shadow-lg hover:bg-right"
            >
              Return to Shop
            </Link>
          </div>
